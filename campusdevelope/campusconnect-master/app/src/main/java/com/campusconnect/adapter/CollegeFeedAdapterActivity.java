...
public class CollegeFeedAdapterActivity extends
    ...
    private List<MyFeedBean> CollegeFeedList;
    int posi = 0;
    ...
    public CollegeFeedAdapterActivity(List<MyFeedBean> CollegeFeedList,Context contect) {
    ...
    public void onBindViewHolder(CollegeFeedViewHolder college_feedViewHolder, int i) {
        MyFeedBean cf = CollegeFeedList.get(i);
        college_feedViewHolder.event_title.setText(cf.getTitle());
        college_feedViewHolder.group_name.setText("group name");
        college_feedViewHolder.timestamp.setText("tiemsta");
